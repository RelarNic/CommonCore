...
/*   Updated: 2025/01/03 20:19:37 by njulia-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	print_flag(const char c, va_list ap)
{
	...
	if (c == 'c')
		...
		count += ft_putvoid_hex(va_arg(ap, void *));
	else if (c == 'X')
		count += ft_putnbr_base(va_arg(ap, unsigned int), "0123456789ABCDEF");
	else
		count += write(1, &c, 1);
...
// 	// Prueba con enteros
// 	custom_count = ft_printf("ft_printf - entero positivo: %d\n",
// 			12345);
// 	original_count = printf("printf    - entero positivo: %d\n",
// 			12345);
// 	printf("Caracteres impresos: ft_printf = %d, printf = %d\n\n", custom_count,
// 		original_count);
